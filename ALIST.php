...
href=alist.php>Teacher details</td>
</table></td></tr>
<tr bgcolor=red><td ><font size=4 color=white>Course
List</font></td></tr>
<tr><td><a href=padd.php>Add New Teacher</a></td></tr>
<tr><td><table width=750 cellspacing=0 cellpadding=5>
<tr bgcolor=#ccccc><td align=center>Teacher ID No</td><td align=center>Teacher
Name</td><td align=center>Subject ID</td><td align=center>Time Slot</td><td
align=center>Options</td></tr>
<?php


$rs1=mysql_query("SELECT * from teacher where ashow='Y' ;");
$sno=1;
while( $row=mysql_fetch_array($rs1)) {
 echo "<tr><td>$row[0]</td><td>$row[1]</td><td>$row[2]</td><td>$row[3]</td><td><a
